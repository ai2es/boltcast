...
def load_data_from_tfds(base_dir='/scratch/bmac87/BoltCast_scratch/',
    ...
    print(train_tf.cardinality)
    if shuffle>0:
        train_tf = train_tf.shuffle(buffer_size=shuffle)
...
if __name__=='__main__':
    ...
    # test_norm(base_dir = '/ourdisk/hpc/ai2es/bmac87/BoltCast_ourdisk/data/10_folds_ds/')
    # tf_train, tf_val, tf_test = load_data(base_dir = '/ourdisk/hpc/ai2es/bmac87/BoltCast_ourdisk/data/10_folds_ds/',
    #         rotation=0,
    #         batch_size=16)
    # print(tf_train,tf_val,tf_test)

    tf_train, tf_val, tf_test = load_data_scratch()
    print(tf_train, tf_val, tf_test)
