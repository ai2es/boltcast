...
def create_parser():
    ...
    parser.add_argument('--image_size', nargs=4, type=int, default=[4,128,256,9], help="Size of input images (rows, cols, channels)")
    ...
    parser.add_argument('--data_path',type=str,default='/scratch/bmac87/BC_tfds_v2/')
    ...
    parser.add_argument('--lstm_conv_activation',type=str,default='elu',help='The activation function')
