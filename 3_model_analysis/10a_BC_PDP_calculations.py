...
def calc_pdp_pkl(loc='vance',
    ...
    for f,feature in enumerate(features):
        ...
        if model_type=='UNet':
            pickle.dump(pred_dict,open('./AIES_results_reviewer_edits/pdp_calculations_pkl/%s_%s_%s_pred_dict.pkl'%(loc,model_type,feature),'wb'))
        if model_type=='LSTM':
            pickle.dump(pred_dict,open('./AIES_results_reviewer_edits/pdp_calculations_pkl/%s_%s_%s_%s_conv_deep_%s_lstm_deep_pred_dict.pkl'%(loc,model_type,feature,conv_deep,lstm_deep),'wb'))
