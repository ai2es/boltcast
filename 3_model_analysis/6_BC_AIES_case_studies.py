...
def get_UNet_outputs(rotation=0):
    ...
    output_dir = '/ourdisk/hpc/ai2es/bmac87/BoltCast_ourdisk/results/AIES_reviews_v2/'
    unet_exp = 'BC_UNet_rot_%s_lrate_0.000010000_/'%(rotation)
    output_file = 'output_labels.pkl'
    unet_output = pickle.load(open(output_dir+unet_exp+output_file,'rb'))
    y_pred_unet = unet_output['model_output']
    return y_pred_unet

def get_LSTM_ouputs(rotation=0):
    print('extracting the LSTM data, rotation:',rotation)
    output_dir = '/ourdisk/hpc/ai2es/bmac87/BoltCast_ourdisk/results/AIES_reviews_v2/'
    lstm_exp = 'BC_LSTM_rot_%s_lrate_0.000010000_/'%(rotation)
    output_file = 'output_labels.pkl'
    lstm_output = pickle.load(open(output_dir+lstm_exp+output_file,'rb'))
    y_pred_lstm = lstm_output['model_output']
    return y_pred_lstm

def get_test_ds(rotation=0):
    print('get_test_ds, rotation: ',rotation)
    ds_dir = '/ourdisk/hpc/ai2es/bmac87/BoltCast_ourdisk/data/BC_edits_v2/BC_test_data_nc/'
...
def generate_variable_model_output_uno_gfs_model_run(rotation=4,
    ...
    try:
        y_pred_lstm = get_LSTM_ouputs(rotation=rotation)
    ...
    axes[0,0].set_ylabel('U-Net',fontsize=18)
    ...
    save_dir = '/home/bmac87/BoltCast/3_model_analysis/AIES_results_reviewer_edits_v2/case_studies/'
    ...
    plt.savefig('/home/bmac87/BoltCast/3_model_analysis/AIES_results_reviewer_edits_v2/case_studies/multi_model_horizontal_colorbar_href.png')
    plt.savefig('/home/bmac87/BoltCast/3_model_analysis/AIES_results_reviewer_edits_v2/case_studies/multi_model_horizontal_colorbar_href.pdf')
    plt.close()
    ...
    plt.savefig('/home/bmac87/BoltCast/3_model_analysis/AIES_results_reviewer_edits_v2/case_studies/multi_model_vertical_colorbar_href.png')
    plt.savefig('/home/bmac87/BoltCast/3_model_analysis/AIES_results_reviewer_edits_v2/case_studies/multi_model_vertical_colorbar_href.pdf')
    plt.close()
