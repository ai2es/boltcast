...
def check_experiments():
    for i in range(100):
        ...
        for feature in features:
            exp_dir='/scratch/bmac87/BoltCast_permutations/'
            fname = '%s_rot_%s_%s_perm_num_100_exp_%s.pkl'%(feature, rotation, model, i)
            if os.path.isfile('/scratch/bmac87/BoltCast_permutations/'+fname)==False:
                print(i, model, rotation,feature)
                print(fname)
...
def get_boxplot_values(feature='cape',
    ...
    load_dir = '/ourdisk/hpc/ai2es/bmac87/BoltCast_ourdisk/data/BC_edits_v2/BoltCast_permutations/'
    if model=='UNet':
...
def AIES_perm_imp(metric='auc_PR'):
    ...
    plt.legend([unet_bar_handles[8],lstm_bar_handles[8]],['U-Net','LSTM'])
    ...
    save_dir = './AIES_results_reviewer_edits_v2/dual_model_single_perm_results/'
    fsave_png = 'dual_bar_perm_imp_11Jan26.png'
    fsave_pdf = 'dual_bar_perm_imp_11Jan26.pdf'
...
def main():
    print('4b BC_plot_perm_importance.py')
